...
export const COMMUNITY_PLACES_SYSTEM_PROMPT_KO = [
  ...
  '- 거리가 가까울수록 가산점 부여',
  '- matchReason: 150-200자, 존댓말, 매칭 이유 위주',
  '- matchReasonTags: 매칭 핵심 키워드 2-3개 (예: ["메뉴 일치", "가까운 거리"])',
...
export const COMMUNITY_PLACES_SYSTEM_PROMPT_EN = [
  ...
  '- matchReason: 150-200 characters, polite language, focus on match reasons',
  '- matchReasonTags: 2-3 keyword tags for match reasons (e.g., ["menu match", "close distance"])',
...
export function getCommunityPlacesRecommendationsJsonSchema(
  ...
  const descriptions = {
    ko: {
      ...
      name: '가게 이름',
      address: '가게 주소',
      matchReason: '추천 이유 (150-200자, 존댓말)',
      matchReasonTags: '매칭 핵심 키워드 태그 (2-3개)',
    ...
    en: {
      ...
      matchReason: 'Match reason (150-200 characters, polite language)',
      matchReasonTags: 'Match reason keyword tags (2-3)',
        ...
        items: {
          ...
          properties: {
            ...
            matchReasonTags: {
              ...
              minItems: 2,
              maxItems: 3,
              description: desc.matchReasonTags,
            },
            matchScore: {
              type: 'number',
