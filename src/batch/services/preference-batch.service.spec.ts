...
describe('PreferenceBatchService', () => {
  ...
  describe('collectFailedSelectionsForRetry', () => {
    it('should collect failed selections with retryCount less than maxRetries', async () => {
      ...
      // Mock for collectFailedSelectionsForRetry (select query)
      mockQueryBuilder.getMany.mockResolvedValue(
        failedSelections as MenuSelection[],
      );

      mockMenuSelectionRepository.createQueryBuilder
        .mockReturnValueOnce(mockUpdateQueryBuilder) // First call: markPermanentlyFailedSelections
        .mockReturnValueOnce(mockQueryBuilder); // Second call: collectFailedSelectionsForRetry
