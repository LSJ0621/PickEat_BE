...
describe('EmailVerificationService', () => {
  ...
  describe('sendCode', () => {
    beforeEach(() => {
      ...
      mockMailerService.sendMail.mockResolvedValue({} as any);
    });
    ...
    it('should throw when undefined dates result in corrupted sendCount exceeding limit', async () => {
      ...
      existing.updatedAt = undefined as any;
      existing.createdAt = undefined as any;
      existing.lastSentAt = undefined as any;
    ...
    it('should successfully send when INVALIDATED record has undefined dates', async () => {
      ...
      existing.updatedAt = undefined as any;
      existing.createdAt = undefined as any; // Also set createdAt to undefined to test fallback
  ...
  describe('verifyCode', () => {
    ...
    it('should not be blocked when failCount is 5 but updatedAt is undefined', async () => {
      ...
      verification.updatedAt = undefined as any;
      verification.createdAt = undefined as any;
