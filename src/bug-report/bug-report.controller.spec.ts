...
describe('BugReportController', () => {
  ...
  describe('createBugReport', () => {
    ...
    it('should create a bug report without files', async () => {
    ...
    it('should create a bug report with files', async () => {
    ...
    it('should return only the id of created bug report', async () => {
      const bugReport = BugReportFactory.create({
        id: 123,
    ...
    it('should handle different bug report categories', async () => {
      const categories = [
        'UI/UX',
        'Performance',
        'Security',
    ...
    it('should accept up to 5 files (FilesInterceptor limit)', async () => {
