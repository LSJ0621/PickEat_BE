...
} from '../../utils/discord-format.util';
import {
  BugReportFactory,
  UserFactory,
...
describe('discord-format.util', () => {
  ...
  describe('formatBugReportSummary', () => {
    ...
    it('should handle bug report with no user email', () => {
      ...
      bug.user = null as unknown as typeof bug.user; // Simulate missing user
    ...
    it('should handle bug report with undefined user', () => {
      ...
      bug.user = undefined as unknown as typeof bug.user; // Simulate undefined user
    ...
    it('should format with bullet point prefix', () => {
      // Arrange
      const user = UserFactory.create();
      const bug = BugReportFactory.create({ user, createdAt: new Date() });
