...
describe('BugReportService', () => {
    ...
    it('should limit images to 5 maximum', async () => {
      ...
      s3Client.uploadBugReportImage.mockImplementation(
        async (file: Express.Multer.File) => {
          return `https://s3.amazonaws.com/bug-reports/${file.originalname}`;
        },
      );
  ...
  describe('findAll', () => {
    it('should return paginated bug reports', async () => {
      ...
      const mockQueryBuilder = bugReportRepository.createQueryBuilder() as any;
  ...
  describe('updateStatus', () => {
    it('should update bug report status', async () => {
      ...
      expect(bugReportRepository.save).toHaveBeenCalledWith(
